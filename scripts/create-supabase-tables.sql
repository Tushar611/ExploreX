...
VALUES 
  ...
  ('mock_rio', 'Rio', 29, 'Software engineer who traded Silicon Valley for the open road. Building apps from hot springs and mountaintops.', '["coding", "hot springs", "mountain biking", "craft beer"]'::jsonb, '["https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400"]'::jsonb, 'Montana', 'Sprinter Van', 'adventure', true, 'adventurer'),
  ('mock_indie', 'Indie', 25, 'Musician and songwriter traveling from festival to festival. My van is my recording studio on wheels.', '["music", "songwriting", "festivals", "campfires"]'::jsonb, '["https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=400"]'::jsonb, 'Tennessee', 'VW Bus', 'slow_travel', true, 'nomad'),
  ('mock_kai', 'Kai', 34, 'Marine biologist turned full-time traveler. Documenting coastal ecosystems from my converted ambulance.', '["marine biology", "diving", "photography", "conservation"]'::jsonb, '["https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400"]'::jsonb, 'Washington', 'Ambulance', 'slow_travel', true, 'explorer'),
  ('mock_willow', 'Willow', 31, 'Herbalist and forager living off-grid. Teaching plant medicine workshops at gatherings across the southwest.', '["herbalism", "foraging", "yoga", "gardening"]'::jsonb, '["https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=400"]'::jsonb, 'New Mexico', 'Skoolie', 'slow_travel', false, null),
  ('mock_diesel', 'Diesel', 36, 'Mechanic and van builder. I fix rigs on the road and help fellow nomads keep rolling.', '["mechanics", "woodworking", "fishing", "BBQ"]'::jsonb, '["https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400"]'::jsonb, 'Texas', 'Ford Transit', 'adventure', true, 'adventurer'),
  ('mock_sage', 'Sage', 24, 'Travel nurse working contracts across the country. Every 3 months a new city, new trails, new friends.', '["nursing", "trail running", "coffee", "reading"]'::jsonb, '["https://images.unsplash.com/photo-1517841905240-472988babdf9?w=400"]'::jsonb, 'North Carolina', 'Sprinter Van', 'adventure', true, 'explorer'),
  ('mock_finn', 'Finn', 28, 'Rock climber and outdoor guide. Chasing crags from Joshua Tree to the Red River Gorge.', '["climbing", "bouldering", "camping", "slacklining"]'::jsonb, '["https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=400"]'::jsonb, 'Nevada', 'Toyota Tacoma', 'adventure', true, 'adventurer'),
  ('mock_aurora', 'Aurora', 33, 'Remote UX designer and aurora chaser. Designing interfaces from the wilderness.', '["design", "aurora hunting", "snowboarding", "photography"]'::jsonb, '["https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?w=400"]'::jsonb, 'Alaska', 'Sprinter Van', 'slow_travel', true, 'nomad'),
